        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./resources/img/Sydney_travel1.jpg" alt="시드니에 있는 오페라 하우스" /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">호주로 갑시다~</div>
                        <h1 class="display-5 fw-bolder">【시드니 시내 명소 관광】시드니/포트스테판</h1>
                        <div class="fs-5 mb-5">
                            <span value="4699000">성인 1,199,000 원</span>
                            <span value="3808480">아동 1,199,000 원</span>
                        </div>
					<p class="lead">
						1일차 : 2023.06.26 (월) 22:35 - 인천 국제 공항 <br /> 
						2일차 : 2023.06.27 (화)
						09:45 - 시드니 국제 공항 – 바랑가루 – 갭팍 – 본다이비치 – 더들리 페이지<br /> 
						3일차 : 룩스거리 – 메레이스 포트스테판 와이너리 – 루라 블루마운틴 - 루라마을 <br /> 
						4일차 : 블루마운틴 – 시드니 대학교
						쿼드랭글 시계탑 – 호주 국립 해양 박물관 <br /> 
						5일차 : 하버브릿지 – 오페라하우스 – 세이트 마리 대성당 – 하이드 파크 <br /> 
						6일차 : 2023.07.01 (토) 11:45 시드니 공항 - 2023.07.01 (토) 21:50 인천 국제 공항 <br />
					</p>
					<div>
                      				  성인
