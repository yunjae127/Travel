...
<html >
    ...
    <body>
        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center"> 
                    <div class="col-md-6">
                    	<!-- <img class="card-img-top mb-5 mb-md-0" src="./resources/img/NewYork_main.jpg" alt="미국에 있는 파크 하야트 호텔 사진" /> -->
            ...
            <ol class='carousel-indicators'>
             ...
             <div class="carousel-inner">
                <div class="item active">
                   <img src="./resources/img/Zurich_main.jpg" alt="First slide">
                </div>
                <div class="item">
                   <img src="./resources/img/Zurich_serve1.jpg" alt="Second slide">               
                </div>
                <div class="item">
                   <img src="./resources/img/Zurich_serve2.jpg" alt="Third slide">                 
                </div>
                <div class="item">
                   <img src="./resources/img/Zurich_serve3.jpg" alt="forth slide">                 
                </div>
             </div>
            ...
            <!-- Controls -->
              ...
              <a class="right carousel-control" href="#carousel-example-generic" data-slide="next">
                <span class="icon-next"></span>
                    ...
                    <div class="col-md-6">
                        <div class="small mb-1">스위스로 갑시다~</div>
                        <h1 class="display-5 fw-bolder">더 돌더 그랜드 호텔</h1><br/>
					<p class="lead">
					
					<ul>
						<li>1. 일반 셔틀 서비스 일부 흡연 구역 에어컨 전 구역 금연 항알레르기 객실</li>
						<br />
						<li>2. 웰빙 피트니스/스파 라커룸 개인 트레이너 피트니스 수업 요가 수업 피트니스</li>
						<br />
						<li>3. 액티비티 자전거 대여 에어로빅 현지 문화 투어/교실 자전거 투어 영화 상영 예술 전시</li>
						<br />
						<li>4. 아웃도어 야외 가구 일광욕 테라스 테라스 정원</li>
						<br />
						<li>위치 : Kurhausstrasse 65, 취리히베르크, 8032 취리히, 스위스</li>
					</ul>
					</p>
				</div>
        ...
        <h3 class = 'hotellocation'>호텔 위치 정보</h3>
       	...
       	<iframe id='review' src="https://www.tripadvisor.co.kr/Hotel_Review-g188113-d196061-Reviews-or750-The_Dolder_Grand-Zurich.html" width="300" height="200"></iframe>
    ...
    var map;
    function initMap() {
        var cityHall = {lat: 47.373206184414755, lng: 8.57503324929565};
