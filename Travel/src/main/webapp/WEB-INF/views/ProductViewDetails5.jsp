        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./resources/img/swiss_notrdam_day6.jpg" alt="미국에 있는 자유의 여신상 사진이다" /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">스위스</div>
                        <h1 class="display-5 fw-bolder">[스위스 일주 8일] 마테호른/융프라우[노옵션/노쇼핑+파노라마 열차]</h1>
                        <div class="fs-5 mb-5">
                            <span>4,399,900</span>
                        </div>
                        <p class="lead">
                 	 	    1일차: 2023.05.19 (금) 11:35 인천 국제 공항 출발 - 2023.05.19 (금) 23:45 취리히 국제공항 도착 – 호텔 이동 <br/>
							2일차 : 취리히 – 루체른(카펠교, 빈사의 사자상) - 중식 특식 (라클렛) - 그린델발트 <br/>
							3일차 : 인터라켄 - 융프라우 - 스핑크스 전망대 – 체르마트 <br/>
							4일차 : 마테호른 – 태쉬 <br/>
							5일차 : 몽트뢰 – 시옹성 – 그뤼에르 – 베른 - 스트라스부르 <br/>
							6일차 : 노트르담 대성당 - 쁘띠 프랑스 - 하이델베르크 - 칼 테오도르 다리 <br/>
							7일차 : 프랑크푸르트 공항 2023.05.26 (금) 10:50 <br/>
							8일차 : 2023.05.27 (토) 09:25 인천 공항 도착</p>
                        <div>
