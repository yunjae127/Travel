        ...
        <section class="py-5">
            <div class="container px-4 px-lg-5 my-5">
                <div class="row gx-4 gx-lg-5 align-items-center">
                    <div class="col-md-6"><img class="card-img-top mb-5 mb-md-0" src="./resources/img/hawai_hanaumabay_day1.jpg" alt="미국에 있는 자유의 여신상 사진이다" /></div>
                    <div class="col-md-6">
                        <div class="small mb-1">하와이!</div>
                        <h1 class="display-5 fw-bolder">[쉐라톤와이키키-MALIASUITE]우리가족하와이7일</h1>
                        <div class="fs-5 mb-5">
                            <span>성인 3,799,000원</span>
                            <span>아동 3,761,000원</span>
                        </div>
                        <p class="lead">
                		1일차 : 2023.05.26 (금) 21:05 인천 국제공항 출발 2023.05.26 (금) 10:15 호놀룰루 국제공항 도착 – 오아후 동부해안 관광 – 하나우마베이 전망대 - 블로우홀<br/>
						2일차 : 쿠알로아 목장 - 폴리네시안민속촌 – 돌 플랜테이션 <br/>
						3일차 : 다이아몬드헤드 – 스타오브 호놀룰루 <br/>
						4일차 : 2023.05.30 (화) 12:35 호놀룰루 국제공항 출발<br/>
						5일차 : 2023.05.31 (수) 17:45 인천 국제공항 도착</p>
                                              <div>
                      				  성인
