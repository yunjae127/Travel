...
<html >
    ...
    <body>
            ...
            <ol class='carousel-indicators'>
             ...
             <div class="carousel-inner">
                <div class="item active">
                   <img src="./resources/img/NewYork_main.png" alt="First slide">
                </div>
                <div class="item">
                   <img src="./resources/img/NewYork_serve1.png" alt="Second slide">               
                </div>
                <div class="item">
                   <img src="./resources/img/NewYork_serve2.png" alt="Third slide">                 
                </div>
                <div class="item">
                   <img src="./resources/img/NewYork_serve3.png" alt="forth slide">                 
                </div>
             </div>
              ...
              <a class="right carousel-control" href="#carousel-example-generic" data-slide="next">
                <span class="icon-next"></span>
                    ...
                    <div class="col-md-6">
                        ...
                        <h1 class="display-5 fw-bolder">파크하얏트 뉴욕</h1><br/>
                        <p class="lead">
						<ul>
							<li>1. 서비스 24시간 룸서비스 세탁 및 드라이클리닝 서비스 <br/> 발렛 의류 보관 서비스 발렛 파킹 및 셀프 주차</li><br/>
							<li>2. 객실 특징 항 알레르기 객실 방음 객실 에어컨 추가 욕실</li><br/>
							<li>3. 객실 유형 산 전망 바다 전망 랜드마크 전망 풀 전망</li><br/>
        ...
        <h3 class = 'hotellocation'>호텔 위치 정보</h3>
       	...
       	<iframe id='review' src="https://www.tripadvisor.co.kr/Hotel_Review-g60763-d6582176-Reviews-Park_Hyatt_New_York-New_York_City_New_York.html" width="300" height="200"></iframe>
    ...
    var map;
    function initMap() {
        var cityHall = {lat: 40.76546179746762, lng: -73.97899940766399};
